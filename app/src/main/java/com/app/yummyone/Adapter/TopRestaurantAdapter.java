...
public class TopRestaurantAdapter extends RecyclerView.Adapter<TopRestaurantAdapter.ViewHolder> {
    ...
    public TopRestaurantAdapter(List<String> restaurantlist) {
        this.restaurantlist = restaurantlist;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_top_restaurent, parent, false);
